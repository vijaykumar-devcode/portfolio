...
export const getAdminSkills = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const updateSkill = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const skill = await Skill.findByIdAndUpdate(
      req.params.id,
      { category, icon, color, items, isVisible },
...
// @access  Private/Admin
export const toggleSkillVisibility = async (req: Request, res: Response, next: NextFunction) => {
  try {
